...
pygame.display.set_caption("Shmup! - v1.0")
...
shoot_sound.set_volume(game_sound_volume)
...
power_sound.set_volume(game_sound_volume)
heal_sound = pygame.mixer.Sound(path.join(snd_dir, 'pow5.wav'))
heal_sound.set_volume(game_sound_volume)
expl_sounds = []
for snd in ['expl3.wav', 'expl6.wav']:
    expl_sound = pygame.mixer.Sound(path.join(snd_dir, snd))
    expl_sound.set_volume(game_sound_volume)
